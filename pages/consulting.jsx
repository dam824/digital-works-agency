          ...
          <div className="row gap-90 align-items-center justify-content-end">
            ...
            <div className="col-lg-10">
              <div className="image pt-30 wow fadeInUp delay-0-2s">
                <img src="assets/images/services/consulting.webp" alt="About" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-two wow fadeInLeft delay-0-2s">
                <div className="icon">
                  <img src="assets/images/icons/analysing.png" alt="Icon"></img>
                </div>
                <h5>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-two wow fadeInLeft delay-0-4s">
                <div className="icon">
                <img src="assets/images/icons/clipboard.png" alt="Icon"></img>
                </div>
                <h5>
                  <Link legacyBehavior href="/service-details">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-two wow fadeInLeft delay-0-2s">
                <div className="icon">
                <img src="assets/images/icons/document.png" alt="Icon"></img>
                </div>
                <h5>
                  <Link legacyBehavior href="/service-details">
                  Conformité RGPD
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-two wow fadeInLeft delay-0-4s">
                <div className="icon">
                <img src="assets/images/icons/regulatory-compliance.png" alt="Icon"></img>
                </div>
                <h5>
                  <Link legacyBehavior href="/service-details">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-two wow fadeInLeft delay-0-6s">
                <div className="icon">
                <img src="assets/images/icons/law.png" alt="Icon"></img>
                </div>
                <h5>
                  <Link legacyBehavior href="/service-details">
          ...
          <div className="row">
            <div className="col-xl-4 col-md-6">
              <div className="pricing-plan-item wow fadeInUp delay-0-2s">
                <div className="icon">
                 <img src="assets/images/icons/layer.png" alt="Icon" />
                </div>
            ...
            <div className="col-xl-4 col-md-6">
              <div className="pricing-plan-item wow fadeInUp delay-0-4s">
                ...
                <div className="icon">
                <img src="assets/images/icons/role-model.png" alt="Icon" />
                </div>
                <h5>Audit Expert</h5>
                <span className="price-text">
                  {/* <span className="before">$</span>
            ...
            <div className="col-xl-4 col-md-6">
              <div className="pricing-plan-item wow fadeInUp delay-0-6s">
                <div className="icon">
                <img src="assets/images/icons/guarantee.png" alt="Icon" />
                </div>
                <h5>Audit Premium</h5>
                <span className="price-text">
                  {/* <span className="before">$</span>
